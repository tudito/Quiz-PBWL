...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'PLN Rantauprapat'); ?></title>
...
<body>
    <div class="d-flex">
        ...
        <div class="sidebar p-3">
            <h4>Menu</h4>
            <a href="<?php echo e(route('golongan.index')); ?>">Daftar Golongan</a>
            <a href="<?php echo e(route('pelanggan.index')); ?>">Daftar Pelanggan</a>
            <a href="<?php echo e(route('users.index')); ?>">Daftar Users</a>
            <a href="#">Log Out</a>
        </div>
...
<?php /**PATH D:\quiz_pbwl\pbwl-quizTudi\resources\views/layouts/app.blade.php ENDPATH**/ ?>